...
// Source: source/stripe/interface.go
...
import (
	...
	stripe "github.com/conduitio/conduit-connector-stripe/source/stripe"
...
func (m *MockStripe) GetResource(startingAfter string) (stripe.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResource", startingAfter)
	ret0, _ := ret[0].(stripe.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
